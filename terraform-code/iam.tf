...
resource "google_service_account" "sa-hub-net" {
  account_id   = "gcp-apse1-sa-hub-net-001"
  display_name = "gcp-apse1-sa-hub-net-001"
...
resource "google_service_account" "sa-sh-vpc-dev" {
  account_id   = "gcp-apse1-sa-sh-vpc-dev-001"
  display_name = "gcp-apse1-sa-sh-vpc-dev-001"
...
resource "google_service_account" "sa-sh-vpc-prd" {
  account_id   = "gcp-apse1-sa-sh-vpc-prd-001"
  display_name = "gcp-apse1-sa-sh-vpc-prd-001"
...
resource "google_service_account" "sa-sh-access" {
  account_id   = "gcp-apse1-sa-sh-access-001"
  display_name = "gcp-apse1-sa-sh-access-001"
...
resource "google_service_account" "sa-dev-env" {
  account_id   = "gcp-apse1-sa-dev-env-001"
  display_name = "gcp-apse1-sa-dev-env-001"
  ...
  depends_on   = [google_project_service.gcp-apse1-apis-dev-env-001]
}
...
resource "google_service_account" "sa-prd-env" {
  account_id   = "gcp-apse1-sa-prd-env-001"
  display_name = "gcp-apse1-sa-prd-env-001"
  ...
  depends_on   = [google_project_service.gcp-apse1-apis-prd-env-001]
}
...
resource "google_service_account" "sa-obs" {
  account_id   = "gcp-apse1-sa-obs-001"
  display_name = "gcp-apse1-sa-obs-001"
