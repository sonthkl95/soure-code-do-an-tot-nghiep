...
# Dev K8s worker 3 (10.10.1.22)
resource "google_compute_instance" "gcp-asia-southeast1-vm-k8s-dev-worker-3" {
  name         = "gcp-asia-southeast1-vm-k8s-dev-worker-3"
  machine_type = "e2-standard-4"
  zone         = "asia-southeast1-b"
  project      = data.google_project.gcp-apse1-prj-dev-env-001.project_id
...
# Prod K8s worker 3 (10.20.1.22)
resource "google_compute_instance" "gcp-asia-southeast1-vm-k8s-prod-worker-3" {
  name         = "gcp-asia-southeast1-vm-k8s-prod-worker-3"
  machine_type = "e2-standard-4"
  zone         = "asia-southeast1-b"
  project      = data.google_project.gcp-apse1-prj-prd-env-001.project_id
